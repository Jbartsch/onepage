...
To use these stylesheets, rename the files and onepage with the name of your theme.
...
onepage-alpha-default-narrow.css  
...
onepage-alpha-default-normal.css
...
onepage-alpha-default-wide.css
